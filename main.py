...
if __name__ == "__main__":  
    ...
    # send_message(ZALO_OA_ACCESS_TOKEN, user_id, message_file="message.txt")    
    ...
    # send_message_to_users(ZALO_OA_ACCESS_TOKEN, users, message_text=MESSAGE_CONTENT, message_file=MESSAGE_FILE_PATH, image_file=IMAGE_FILE_PATH)
    ...
    if SEND_MESSAGE_TEXT == 'True':
        if SEND_MESSAGE_WITH_IMAGE == 'True':
            ...
            send_message_to_users(ZALO_OA_ACCESS_TOKEN, users, message_file=MESSAGE_FILE_PATH, image_file=IMAGE_FILE_PATH)
        else:
            print("SEND_MESSAGE_TEXT: ", SEND_MESSAGE_TEXT)
            send_message_to_users(ZALO_OA_ACCESS_TOKEN, users, message_file=MESSAGE_FILE_PATH)
